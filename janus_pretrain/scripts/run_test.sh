...
DATA_PATH=/data1/lxb/huawei_pretrain/bert_data_22g/train/data-bin/test_dir/
# DATA_PATH=/data1/lxb/huawei_pretrain/gpt_160g/
MODEL_PATH=/data1/lxb/huawei_pretrain/pretraining/ckpt/janus/test
...
python -m torch.distributed.launch --nproc_per_node=1 --master_port=1234 \
    ...
    --max-sentences 8 --update-freq 16 \
    --log-format simple \
    --log-interval 100 \
    --ddp-backend=no_c10d \
