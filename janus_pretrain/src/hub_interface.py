...
class EncDecHubInterface(GeneratorHubInterface):
    """A simple PyTorch Hub interface to BART.
    Usage: https://github.com/pytorch/fairseq/tree/main/examples/bart
    """

    def __init__(self, cfg, task, model):
        cfg['bpe']['gpt2_encoder_json'] = "/data1/lxb/huawei_pretrain/GLGE/glge-released-dataset/easy/squadqg_data/train_data/train/encoder.json"
        cfg['bpe']['gpt2_vocab_bpe'] = "/data1/lxb/huawei_pretrain/GLGE/glge-released-dataset/easy/squadqg_data/train_data/train/vocab.bpe"
    ...
    def sample(
        ...
        #     for hypos_item in hypos:
        #         for history in hypos_item["history"]:
        #             print(self.decode(history['tokens']))
