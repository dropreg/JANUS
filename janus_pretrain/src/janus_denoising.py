...
from .janus_span_dataset import DenoisingSpanDataset
...
@register_task("janus_denoising")
class JanusDenoisingTask(LegacyFairseqTask):
    """
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        # our dataset
        self.datasets[split] = DenoisingSpanDataset(
            dataset,
            dataset.sizes,
            self.dictionary,
            self.mask_idx,
